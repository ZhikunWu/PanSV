...
rule all:
    input:
        ...
        expand(IN_PATH + '/NGS/VCF/{sample}/{sample}_NGS.g.vcf', sample=SAMPLES),
        #IN_PATH + "/SVCall/Sniffles2/Samples_SV_merge.vcf",
        #IN_PATH + "/GenePrediction/RNA/hisat/Fengchan6/ngs_RNA_hisat.bam",
        #IN_PATH + "/GenePrediction/RNA/Stringtie/Fengchan6/Fengchan6_RNA_stringtie_exon.fasta",
        #IN_PATH + "/GenePrediction/RNA/hisat/Fengchan6/flower_RNA_hisat.bam",
        #expand(IN_PATH + "/Evaluation/BUSCO/ragtag/All_busco_summary.xls", sample=SAMPLES),
