...
rule all:
    input:
        expand(IN_PATH + "/Assembly/Scaffold/Stats/{sample}.scaffold.stats.txt", sample=SAMPLES),
        expand(IN_PATH + "/Assembly/Scaffold/Stats/{sample}.anchor.ratio.txt", sample=SAMPLES),
